...
== Backup Just Updated to Version 2.0.0! (And now updated to 2.1.0)

== IMPORTANT: Backup SQLite3 Database will no longer be utilized!
Backup will no longer utilize the Backup SQLite3 Database as of version 2.1.0!
It seemed some users were having a struggle with SQLite3 and maintaining it with Backup, so I decided to get rid of it
