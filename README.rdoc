...
That's it! Now you have both configured the files, and have the backup rake tasks at your disposal!
...
The rest usually comes with any Linux flavor. So you will probably be set, assuming you're running Linux or any other UNIX based system.
...
Also, Ryan Bates has created a screencast about this gem, see it here: http://railscasts.com/episodes/164-cron-in-ruby
