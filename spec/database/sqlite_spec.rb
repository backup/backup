  ...
  describe Database::SQLite do
    ...
    describe "#initialize" do
      ...
      it "should pass the model reference to Base" do
        db.instance_variable_get(:@model).should eq(model)
      end

      context "when no pre-configured defaults have been set" do
        context "when options are specified" do
          it "should use the given values" do
            db.sqlitedump_utility.should eq("/path/to/sqlitedump")
          end
        end
      ...
      context "when pre-configured defaults have been set" do
        ...
        context "when options are not specified" do
          it "should use the pre-configured defaults" do
            ...
            db.sqlitedump_utility.should eq("/default/path/to/sqlitedump")
          end
        end
      end # context 'when no pre-configured defaults have been set'
