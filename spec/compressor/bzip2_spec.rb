  ...
  describe "#initialize" do
    ...
    context "when no pre-configured defaults have been set" do
      it "should use default values" do
        ...
        compressor.instance_variable_get(:@cmd).should eq("bzip2")
        compressor.instance_variable_get(:@ext).should eq(".bz2")
      end
      ...
      it "should use the values given" do
        ...
        compressor.instance_variable_get(:@cmd).should eq("bzip2 -5")
        compressor.instance_variable_get(:@ext).should eq(".bz2")
      end
    ...
    context "when pre-configured defaults have been set" do
      ...
      it "should use pre-configured defaults" do
        ...
        compressor.instance_variable_get(:@cmd).should eq("bzip2 -7")
        compressor.instance_variable_get(:@ext).should eq(".bz2")
      end
      ...
      it "should override pre-configured defaults" do
        ...
        compressor.instance_variable_get(:@cmd).should eq("bzip2 -6")
        compressor.instance_variable_get(:@ext).should eq(".bz2")
      end
