...
module Backup
  ...
  SYNCERS     = ['RSync', 'S3']
  NOTIFIERS   = ['Mail', 'Twitter', 'Campfire', 'Presently', 'Sendmail']
  ...
  module Configuration
    ...
    module Notifier
      ...
      autoload :Sendmail,  File.join(CONFIGURATION_PATH, 'notifier', 'sendmail')
  ...
  module Notifier
    ...
    autoload :Sendmail,  File.join(NOTIFIER_PATH, 'sendmail')
